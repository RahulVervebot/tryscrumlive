    ...
    return (
      ...
      >
        ...
        <section className="course-details" style={{fontFamily:"verdana"}}>
          <div className="container-fluid" style={{fontFamily:"verdana"}}>
            <div className="row">
              <div className="col-lg-9">
                <div className="course-details__content" style={{fontFamily:"verdana"}}>
                  ...
                  <div className="course-details__top">
                    <div className="course-details__top-left">
                      <h1 className="course-details__title" style={{fontFamily:"verdana"}}>{course.title}</h1>
              ...
              <div className="col-lg-12 choaching_col_course" style={{flex:"1", margin:"2%", borderRadius:"30px 30px 0 0", padding: "0"}}>
              ...
              <div className="col-md-6">
                <div className="content">
                  ...
                  <h2 style={{ fontSize: "22px" }}>
                    {" "}
                    Professional Scrum Master training with tryScrum is intense
                    and creative. You can do more than getting certified. More
                    than 8000 agile professionals chose to take their Scrum
                    Master training with us, and we'd love to welcome you to a
                    future course.{" "}
                  </h2>
          ...
          <div className="courseStripePSPO1" style={{fontFamily:"verdana"}}>
            <div className="modal-body row">
              <div className="col-md-6">
                <div className="content">
                  <h2 class="h1 bordered">
                    Become a Skilled Product Owner&nbsp;
                  </h2>
                  <h2 style={{ fontSize: "22px" }}>
                    Our Scrum Product Owner workshop is intense and creative.
                    You'll not only understand the roles and responsibilities of
                    a product owner, but you'll also learn how to maximise value
                    from the Scrum team's work.{" "}
                  </h2>
      ...
      >
        ...
        <div>
          <div className="courseStripePSM" style={{fontFamily:"verdana"}}>
            ...
            <div className="newCoursePageImg2" style={{ marginLeft: "10px" }}>
              <img src={Cspol} alt="" />
              {/* </div>
               <div className="newCoursePageImg2 py-4" style={{ marginLeft: "10px" }}> */}
              <div>
                <h2
                  style={{
                    marginLeft: "10px",
                ...
                <br />
                <p className="badges-top" style={{ marginLeft: "10px" }}>
                  {/* <span className="badge badge-certified">Certified</span> */}
                  <span className="badge badge-live-online">Live Online</span>
                  <span className="badge badge-in-person">In Person</span>
                </p>
          ...
          <div
            ...
            style={{ backgroundColor: "#f06524", fontFamily:"verdana" }}
          >
            <div className="modal-body row">
              <div className="col-md-6">
                <div class="content">
                  <h2 class="h1 bordered">
                    Become an inspiring Product Owner&nbsp;
                  </h2>
                  <h2 style={{ fontSize: "22px" }}>
                    {" "}
                    Our Certified Product Owner equips you with the invaluable
                    skills to skyrocket your confidence, amplify your
                    credibility, and unlock your true value as a visionary
                    Product Owner.{" "}
                  </h2>
              ...
              <div className="course-details__content">
                ...
                >
                  <div
                    ...
                    aria-labelledby="home-tab"
                  >
                    <p className="course-details__tab-text makingblack mb-4">
                      <h2 style={{ color: "red" }}>Who is a Product Owner?</h2>
                      <div className="all-courses-font">
                        A product owner is a value maximizer accountable for maximizing the product's value resulting from the scrum team's work. Product Owners have a unique and crucial role in helping the team focus on the most valuable item for a customer. Product owners are often focused on products and the product's value in the marketplace while collaborating with the scrum team.
                      </div>
                    </p>
                    ...
                    <p className="course-details__tab-text makingblack mb-4">
                      <h2 style={{ color: "red" }}>What is the Certified Scrum Product Owner course?</h2>
                      <div className="all-courses-font">
                        If you're ready to grow as a Product Owner, our <a href="#table-responsive">Certified Scrum Product Owner (CSPO®)</a> course is designed for you. You'll learn the skills and traits required to grow as a product owner and gain an understanding of the necessary competencies to succeed in your role.
                        Considered the gold certification standard, the CSPO course is an intense and immersive experience. Taught by the award-winning, experienced Scrum trainer at tryScrum, each CSPO class is intense and integrates the real-world challenges of a Product Owner in a complex environment.
                        Our training program gives you hands-on skills to immediately apply in the real world and expand your career opportunities. Once you complete the course, you will be invited to join the product owner community by accepting the Scrum Alliance licensing agreement.
                      </div>
                    </p>

                    <p className="course-details__tab-text makingblack mb-4">
                      <h2 style={{ color: "red" }}>
                        Who can enroll for the Certified Scrum Product Owner course?
                      </h2>
                      <div className="all-courses-font">
                        PRODUCT OWNERS | BUSINESS ANALYSTS | PROJECT MANAGERS | PRODUCT MANAGERS | TEAM MEMBERS | DATA ANALYSTS
                        Anyone new to agile will find the CSPO course valuable. Scrum Product Ownership is an emerging and promising career in most of industries today. Product owner jobs—and the irreplaceable people skills these roles require—are on the rise. In 2020, <a href="https://business.linkedin.com/content/dam/me/business/en-us/talent-solutions/emerging-jobs-report/Emerging_Jobs_Report_U.S._FINAL.pdf" target="_blank">LinkedIn named it the #15 emerging job</a>, with a 24% annual growth. The World Economic Forum went even further, calling it the <a href="http://www3.weforum.org/docs/WEF_Future_of_Jobs_2020.pdf" target="_blank">#1 job needed for the emerging global workforce</a>.
                      </div>
                    </p>
                    ...
                    <p className="course-details__tab-text makingblack">
                      <h2 style={{ color: "red" }}>Course Details</h2>
                      <div
                        className="all-courses-font"
                        dangerouslySetInnerHTML={{
                          __html: course.acfcoursePage.options.thecourse,
          ...
          <div style={{ backgroundColor: "#73b89e" , fontFamily:"Verdana"}}>
            <div className="modal-body row">
              <div className="col-md-6">
                <div class="content">
                  <h2 class="h1 bordered">
                    Become an Inspiring Scrum Master&nbsp;
                  </h2>
                  <h2 style={{ fontSize: "22px" }}>
                    Certified Scrum Master training with tryScrum is intense and
                    innovative. You can do more than get certified. More than
                    10000 agile professionals chose to take their Scrum Master
                    training with us, and we'd love to welcome you to a future
                    course.
                  </h2>
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="course-details__tab-text makingblack mb-3">
                        <h2 style={{ color: "red", fontFamily:"verdana" }}>Who is a Scrum Master?</h2>
                        <div
                          className="all-courses-font"
                        >
                          A scrum master is accountable for establishing a Scrum Framework to help the Scrum team deliver value iteratively and incrementally by ensuring everyone in the team understands the purpose of the framework instead of just the mechanics of the framework. They help the scrum team by creating a healthy work environment and guiding others to embrace the values of the scrum. Scrum masters are often focused on people who possess intelligence and derive satisfaction from facilitating the growth of team members.
                        </div>

                        <div className="all-courses-font">If you want to become a scrum master or are considering implementing scrum. Our <a href="#table-responsive">Certified ScrumMaster® (CSM®)</a> course is the starting point. Through this course, you will develop a comprehension of scrum. Gain practical knowledge on effectively incorporating it within your team and organization.</div>
                      </p>

                      <p className="course-details__tab-text makingblack mb-3">
                        <h2 style={{ color: "red", fontFamily:"verdana"  }}>What is the Certified ScrumMaster course?</h2>
                        <div
                          className="all-courses-font"
                        >
                        ...
                        <div className="all-courses-font">The CSM course is an interactive and engaging learning experience known for its popularity. Taught by the award-winning, experienced Scrum trainer at tryScrum, each CSM class is intense and integrates the real-world challenges of a Scrum Master.</div>

                        <div className="all-courses-font">Our training program gives you hands-on skills to immediately apply in the real world and expand your career opportunities. Once you complete the course, you will have everything you need to take and pass the CSM exam.</div>
                      </p>

                      <p className="course-details__tab-text makingblack mb-3">
                        <h2 style={{ color: "red", fontFamily:"verdana" 
                        
                         }}>Who can enroll for the Certified ScrumMaster course?</h2>
                        <div
                          className="all-courses-font"
                        >
                        ...
                        <div className="all-courses-font">Anyone new to agile will find value in the concepts covered in the CSM course. Scrum is applicable across industries and potentially cross-functional teams, so marketers, data scientists, HR representatives, and other professionals looking for a better way to solve complex problems are encouraged to attend.</div>
                      </p>
