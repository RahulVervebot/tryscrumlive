...
import cass1 from "../assets/images/new-logos/casp1sm.png";
import cal1_logo from "../assets/images/new-logos/cal1.png";
...
import Cspol from "../assets/images/cspobanner.png";
...
const PostTemplate = ({ data }) => {
  ...
  console.log("course value uri title", title);
  console.log("course value uri metadesc", metadesc);
  ...
  <br/>
    ...
    return (
      ...
      >
        ...
        <div>
         <div style={{ backgroundColor: "#7ea33f" , fontFamily:"Verdana"}}> 
