                ...
                <ul className="navigation-box">
                  ...
                  <li onClick={this.showHidetoggleclose}>
                    ...
                    <ul className="sub-menu">
                      ...
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/enterprise-coaching-consulting">
                          tryBusiness Agility
                        </Link>
                      </li>
                    </ul>
                  ...
                  <li onClick={this.showHidetoggleclose} className="hideonfull">
                    <Link className="secondmenu" to="/certifications">
                      Courses
                    </Link>
                    <ul className="sub-menu">
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/scrum-master/certified-scrum-master-csm/">
                          Certified Scrum Master
                        </Link>
                      </li>
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/scaling/certified-agile-skills-scaling-level-1/">
                          Certified Agile Skills Scaling Level 1
                        </Link>
                      </li>
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/scrum-master/advanced-certified-scrum-master-acsm/">
                          {/* <img src={csm} /> */}
                          Advanced Certified Scrum Master
                        </Link>
                      </li>
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/product-owner/certified-scrum-product-owner-cspo/">
                      ...
                      >
                        <Link to="/certifications/agile/scrum/product-owner/advanced-certified-scrum-product-owner-acspo/">
                      ...
                      <li
                        ...
                        style={{ whiteSpace: "none" }}
                      >
                        <Link to="/certifications/agile/scrum/product-owner/professional-product-discovery-and-validation/">
                      ...
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/leadership/certified-agile-leadership-i/">
                          {" "}
                      ...
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/leadership/certified-agile-leadership-ii/">
                          Certified Agile Leadership - II
                        </Link>
                      </li>

                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/leadership/certified-agile-leadership-combination/">
                          Certified Agile Leadership (I and II) Combo
                        </Link>
                      </li>

                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/leadership/professional-agile-leadership-essentials-pal-e/">
                      ...
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/scrum-master/professional-scrum-master-i-psm/">
                          Professional Scrum Master I
                        </Link>
                      </li>

                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/scrum-master/professional-scrum-master-ii/">
                          Professional Scrum Master II
                        </Link>
                      </li>
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/product-owner/professional-scrum-product-owner-i-pspo/">
                  ...
                  <li onClick={this.showHidetoggleclose}>
                      ...
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/product-owner/professional-agile-leadership-evidence-based-management/">
                          PAL - Evidence-Based Management
                        </Link>
                      </li>

                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/product-owner/product-management-certification-icp-pdm/">
                          Product Management – Practitioner(ICP-PDM)
                        </Link>
                      </li>
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/product-backlog-management/">
                        Professional Scrum Product  Backlog Management (PSPBM)
                        </Link>
                      </li>

                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/scaling/scaled-professional-scrum-sps-training/">
                          Scaled Professional Scrum
                        </Link>
                      </li>
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/facilitation/professional-scrum-facilitation-skills-psfs/">
                          Professional Scrum Facilitation Skills
                        </Link>
                      </li>
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/facilitation/agile-coaching-skills-certified-facilitator-acs-cf/">
                        Certified Agile Facilitator
                        </Link>
                      </li>
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/agile-coaching-certification-icp-acc-training/">Agile Coaching (ICP-ACC)</Link>
                      </li>
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/enterprise-agile-coaching-icp-ent-training/">
                          Agility in the Enterprise (ICP-ENT)
                        </Link>
                      </li>
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/coaching-agile-transformation-icp-cat-training/">
                          Coaching Agile Transitions (ICP-CAT)
                        </Link>
                      </li>

                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/kanban/applying-scaled-portfolio-kanban/">
                          Applying Scaled Portfolio Kanban
                        </Link>
                      </li>

                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/kanban/professional-scrum-with-kanban/">
                          Professional Scrum with KanBan
                        </Link>
                      </li>
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/kanban/applying-professional-kanban-apk/">
                          Applying Professional KanBan
                        </Link>
                      </li>

                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/kanban/applying-metrics-for-predictability-apm/">
                          Applying Metrics for Predictability(APM)
                        </Link>
                      </li>

                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/scrum/professional-scrum-with-user-experience-psu/">
                          Professional Scrum with UX
                        </Link>
                      </li>

                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/certified-less-basics-icp-clb-training/">
                          Certified LeSS Basics
                        </Link>
                      </li>

                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/certified-less-practitioner-clp-training/">
                          Certified LeSS Practitioner
                        </Link>
                      </li>

                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/business-agility-foundations-icp-baf-training/">
                          Business Agility - Essentials (ICP-BAF)
                        </Link>
                      </li>
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/certifications/agile/agile-certified-practitioner-pmi-acp-training/">
                      ...
                      <li onClick={this.showHidetoggleclose}>
                        <Link
                          to="/certifications/agile/scrum/developer/applying-professional-scrum/"
                          target="__blank"
                        >
                          APS
                        </Link>
                      ...
                      <li onClick={this.showHidetoggleclose}>
                        <Link
                          to="/certifications/agile/scrum/developer/applying-professional-scrum-for-software-development/"
                          target="__blank"
                        >
                      ...
                      >
                        <div className="row p-2 pt-0 mt-0 bg-white">
                          ...
                          <div className="col-md-4">
                            ...
                            <ul className="sub-menu mega-menu-alignment">
                              <li onClick={this.showHidetoggleclose}>
                                <Link to="/certifications/agile/agile-coaching-certification-icp-acc-training/">
                                  <img src={icpacc} />
                          ...
                          <div className="col-md-4">
                            ...
                            <ul className="sub-menu mega-menu-alignment">
                              <li onClick={this.showHidetoggleclose}>
                                <Link
                                  to="/certifications/agile/certified-less-basics-icp-clb-training/"
                                  target="_blank"
                                >
                              ...
                              <li onClick={this.showHidetoggleclose}>
                                <Link
                                  to="/certifications/agile/certified-less-practitioner-clp-training/"
                                  target="_blank"
                                >
                              ...
                              <li onClick={this.showHidetoggleclose}>
                                <Link
                                  to="/certifications/agile/business-agility-foundations-icp-baf-training/"
                                  target="__blank"
                                >
                                  <img src={icpbaf} />
                                  Business Agility - Essentials (ICP-BAF)
                              ...
                              <li onClick={this.showHidetoggleclose}>
                                <Link to="/certifications/agile/agile-certified-practitioner-pmi-acp-training/" target="__blank">
                                  <img src={pmi} />
                                  Project Management Institute- Agile Certified
                                  Practitioner (PMI-ACP)
                                </Link>
                  ...
                  <li onClick={this.showHidetoggleclose}>
                    ...
                    <li onClick={this.showHidetoggleclose}>
                      ...
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/agile-coach-competencies">
                  ...
                  <li onClick={this.showHidetoggleclose}>
                    ...
                    <ul className="sub-menu">
                      ...
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/virtual-class-special-instructions">
                          Virtual Class Instructions
                        </Link>
                      </li>
                      <li onClick={this.showHidetoggleclose}>
                        <Link to="/which-scrum-role-is-right-for-me">
