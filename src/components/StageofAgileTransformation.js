...
const StageofAgileTransformation = () => {
  ...
  const submitHandler = async e => {
    ...
    //   setloader("loading")
      const url =
        "https://tryscrumlive.vervebot.io//wp-json/contact-form-7/v1/contact-forms/8252/feedback?_wpcf7_unit_tag=wpcf7-0c043f6"
            ...
            <div className="blog-one__single">
              ...
              <div className="blog-one__content text-center">
                ...
                <p className="blog-one__text">
                  Are you looking to embark on an Agile transformation journey
                  for your organisation? Look no further than tryScrum's white
                  paper on the Stages of Agile Transformation. In this paper, we
                  discuss the stages of Agile transformation based on extensive
                  research and collaboration with experienced Agile coaches.
                </p>

                <p className="blog-one__text">
                  At tryScrum, we have worked with numerous organisations,
                  ranging from startups to large corporations, and have
                  identified the critical stages of Agile transformation that
                  companies typically go through. We present a framework that
                  outlines these stages, from initial adoption to full-scale
                  implementation, along with practical guidance and real-world
                  examples to help organisations on their Agile transformation
                  journey.
                </p>
              </div>
            </div>
...
export default StageofAgileTransformation
