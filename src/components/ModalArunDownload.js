...
const ModalArunDownload = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if (state.email && state.name && checked) {
      ...
      setloader('loading');
      const url =
        "https://tryscrumlive.vervebot.io//wp-json/contact-form-7/v1/contact-forms/7949/feedback?_wpcf7_unit_tag=wpcf7-b792eb0";
      ...
      if(res){
        handleDownload("/arunvignesh-profile.pdf","arunvignesh-profile.pdf")
      }
  ...
  return (
    <>
      ...
      <button onClick={showModal} className="btn m-0 w-100" style={{ fontWeight: "600", border: "3px solid #73B79E", boxShadow: "none", color: "#fff", backgroundColor: "#73B79E",padding:"5px 5px", whiteSpace:"nowrap" }}>Download CV</button>
          ...
          <div className='modal_box'>
            <form>
              ...
              {loader == 'loading' ? <button
                ...
                className="btn ml-0"
                disabled
                style={{background:"#73B79E", color:"#fff"}}
...
export default ModalArunDownload
