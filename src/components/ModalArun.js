...
const ModalArun = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if (state.email && state.name && checked) {
      ...
      setloader('loading');
      const url =
        "https://tryscrumlive.vervebot.io//wp-json/contact-form-7/v1/contact-forms/7926/feedback?_wpcf7_unit_tag=wpcf7-77ea71e";
  ...
  return (
    <>
      <button onClick={showModal} className="btn m-0 w-100" style={{ fontWeight: "600", border: "3px solid #73B79E", boxShadow: "none", color: "#fff", backgroundColor:"#73B79E",padding:"5px 5px", whiteSpace:"nowrap" }}>Contact Trainer</button>
      ...
      <div className='modal_container' style={{ display: `${modal}` }}>
        <div className='modal_content modal_content_in_mobile'>
          <i fa className='fa fa-times close_modal' style={{color:"#73B79E"}} onClick={hideModal}></i>
          <div className='modal_box pt-2'>
            <form className='row'>

              <div className="form-group col-xl-6 col-md-12 col-sm-12 col-lg-6  mb-0">
                <label for="exampleInputEmail1 pb-0 mb-0">Email address</label>
              ...
              <div className="form-group col-xl-6 col-md-12 col-sm-12 col-lg-6  mb-0">
                <label for="formGroupExampleInput pb-0 mb-0">Your Name</label>
                <input
                  type="name"
                  className="form-control"
                  id="exampleInputEmail1"
              ...
              <div className="form-group col-xl-6 col-md-12 col-sm-12 col-lg-6  mb-0">
                <label for="formGroupExampleInput mb-0">Phone Number</label>
                <input
                  type="number"
                  className="form-control"
                  id="exampleInputEmail1"
              ...
              <div className="form-group col-xl-6 col-md-12 col-sm-12 col-lg-6  mb-0">
                <label for="formGroupExampleInput mb-0">Country</label>
                <input
                  type="text"
                  className="form-control"
                  id="exampleInputEmail1"
              ...
              <div className="form-group col-xl-12 col-md-12 col-sm-12 col-lg-6  mb-0">
                <label for="formGroupExampleInput mb-0">Please let me know the service you are looking for:</label>
                <textarea
                  type="text"
                  className="form-control"
                  id="exampleInputEmail1"
