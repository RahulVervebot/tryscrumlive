...
const TeamCoachingCanvasContent = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if (state.email && state.name ) {
      ...
      setloader('loading');
      const url =
        "https://tryscrumlive.vervebot.io//wp-json/contact-form-7/v1/contact-forms/5731/feedback?_wpcf7_unit_tag=wpcf7-d461a94";
  ...
  console.log(errors.checkbox, "checkbox")
