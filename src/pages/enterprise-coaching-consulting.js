...
const Coaching = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if (state.email && state.name && state.message) {
      ...
      const url = "https://tryscrumlive.vervebot.io//wp-json/contact-form-7/v1/contact-forms/94/feedback?_wpcf7_unit_tag=wpcf7-d0c0bb5";
  ...
  //   linkUS.href = "https://www.tryscrum.com/enterprise-coaching-consulting/";

  //   const linkIN = document.createElement("link");
  //   linkIN.rel = "alternate";
  //   linkIN.hreflang = "en-IN";
  //   linkIN.href = "https://www.tryscrum.com/in/enterprise-coaching-consulting/";
    ...
    <Layout pageTitle="Enterprise Coaching & Consulting" metaDesc="Spinning up a single Scrum team is a challenge. Building an agile organization is a journey. We work with you to create a plan and execute it to build and sustain an agile organization." pageName="enterprise_coaching_consulting" >
      ...
      <div className="container mb-3">
        <div className="row ">
          ...
          <button type="button" className="btn btn-danger btn-lg" onClick={showModal}>Engage Us</button>
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", margin: "auto 0" }}>
                <form
                  action="#"
                  method="POST"
                  className="become-teacher__form-content contact-form-validated col-12 pt-2 pb-0 border border-0 px-2"
                >
                  ...
                  <div className="row">
                    <div className="col-md-12 centered-popup-input mb-0">
                      <input type="submit" class="btn btn-success btn-send btn-block" value="Send message" onClick={submitHandler} />
                      <br />
        ...
        <div className="row justify-content-center">
          <div className="col-md-6 text-center">
            <Popup
              ...
              modal
              nested
              style={{ width: "50%", boxShadow: "rgba(0, 0, 0, 0.07) 0px 1px 2px, rgba(0, 0, 0, 0.07) 0px 2px 4px, rgba(0, 0, 0, 0.07) 0px 4px 8px, rgba(0, 0, 0, 0.07) 0px 8px 16px, rgba(0, 0, 0, 0.07) 0px 16px 32px, rgba(0, 0, 0, 0.07) 0px 32px 64px" }}
            >
              {close => (
                <div>
                  <div className="px-2 pt-1">
